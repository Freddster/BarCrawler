...
namespace BarCrawler.Models
{
    ...
    public class BarModel
    {
        ...
        /// </summary>
        /// <remarks>The property [Timestamp] defines optimistic locking using <see cref="TimestampAttribute">Timestamp</see></remarks>
        ...
        /// <remarks>
        /// This property is marked with a [MaxLength] tag<see cref= "MaxLengthAttribute" > Maxlengthattribute </see><br/>
        /// It also has a [Display] tag <see cref="DisplayAttribute">Displayattribute</see></remarks>
        /// <seealso cref="MaxLengthAttribute"/>
        /// <seealso cref="DisplayAttribute"/>
        [MaxLength(1000)]
